...
class MainActivity : BaseActivity<ActivityMainBinding>(ActivityMainBinding::inflate) {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        navController.addOnDestinationChangedListener { _, destination, _ ->
            when (destination.id) {
                R.id.splashScreenFragment, R.id.loginFragment, R.id.emailFragment, R.id.OTPFragment, R.id.newPasswordFragment, R.id.timetableFragment, R.id.classInformationFragment, R.id.classRegistrationFragment, R.id.generalNotificationFragment, R.id.accountFragment, R.id.personal_NotificationFragment-> {
